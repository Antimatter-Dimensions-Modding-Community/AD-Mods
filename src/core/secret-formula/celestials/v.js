...
export const v = {
  ...
  mainUnlock: {
    realities: {
      ...
      progress: () => Currency.realities.value.div(1584).min(1).toNumber(),
    },
    eternities: {
      id: 2,
      name: "Eternities",
      ...
      requirement: 1e56,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.eternities.value.max(1).log10(), 56),
    },
    infinities: {
      id: 3,
      name: "Infinities",
      ...
      requirement: 1e128,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.infinitiesTotal.value.max(1).log10(), 128),
    },
    dilatedTime: {
      id: 4,
      name: "Dilated Time",
      ...
      requirement: DC.E256,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxDT.max(1).log10(), 256),
    },
    replicanti: {
      id: 5,
      name: "Replicanti",
      resource: () => player.records.thisReality.maxReplicanti,
      requirement: DC.E256000,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxReplicanti.max(1).log10(), 256000),
    },
    realityMachines: {
      id: 6,
      ...
      requirement: 1e48,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.realityMachines.value.max(1).log10(), 48),
    },
  },
  runUnlocks: [
    {
